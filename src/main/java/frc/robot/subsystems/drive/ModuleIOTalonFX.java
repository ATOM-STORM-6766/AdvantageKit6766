...
public class ModuleIOTalonFX implements ModuleIO {
  ...
  public ModuleIOTalonFX(
    ...
    BaseStatusSignal.setUpdateFrequencyForAll(
        Drive.ODOMETRY_FREQUENCY, driveVelocity, drivePosition, turnVelocity, turnPosition);
    BaseStatusSignal.setUpdateFrequencyForAll(
        50.0, driveAppliedVolts, driveCurrent, turnAbsolutePosition, turnAppliedVolts, turnCurrent);
